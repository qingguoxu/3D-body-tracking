...
extern std::vector<cv::Mat> ColorImagesQueue;
extern std::vector<cv::Mat> depthImagesQueue;
extern std::vector<cv::Mat> maskImagesQueue;

extern int kinect_read_frame_counter; // how many frames read into the buffer

//extern std::vector<int> frame_counter_global;
...
public:
	...
	RGBQUAD*                m_pOutputRGBX_depthSpace;
	RGBQUAD*                m_pBackgroundRGBX;
	RGBQUAD*                m_pBackgroundRGBX_depthSpace;
